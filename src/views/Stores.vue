      ...
      <ion-list>
        ...
        <ion-item>
          <ion-avatar slot="start">
            <img src="https://i.pinimg.com/originals/f9/2e/ab/f92eab3755a5003dc0f639bda476573e.png">
          </ion-avatar>
          <ion-label>
            <h2>Digital Magic Store</h2>
<!--            <p>Button on right</p>-->
          </ion-label>
